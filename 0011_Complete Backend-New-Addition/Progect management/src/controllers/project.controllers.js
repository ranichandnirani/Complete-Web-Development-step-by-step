...
const addMembersToProject = asyncHandler(async(req, res) => {
    ...
    if(!user) {
        throw ApiError(404, "User does not existts");
    }
    ...
    return res.status(201).json(new ApiResponse(201, {}, "Project member added seccessfully"));
...
const updateMembersRole = asyncHandler(async(req, res) => {
    ...
    if(!AvailableUserRole. includes(newRole)) {
        throw new ApiError(400, "Invalides Role");
    }
